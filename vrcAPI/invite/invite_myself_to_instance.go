...
func InviteMyselfToInstance(c *vrcAPI.Client, worldID, instanceID string) (*SentNotification, error) {
	req, err := c.NewRequest("POST", vrcAPI.API_ENDPOINT+"/invite/myself/to/"+worldID+":"+instanceID, nil)
