...
func GetWorldInstance(c *vrcAPI.Client, worldID string, instanceID int) (*Instance, error) {
	req, err := c.NewRequest("GET", vrcAPI.API_ENDPOINT+"/worlds/"+worldID+"/"+strconv.Itoa(instanceID), nil)
